...
def test_tiny_bacon_number():
    # Actors with bacon number 0
    n0 = 0
    expected0 = {4724}
    result0 = lab.actors_with_bacon_number(db_tiny, n0)
    assert result0 == expected0

    n1 = 1
    expected1 = {2876, 1532}
    result1 = lab.actors_with_bacon_number(db_tiny, n1)
    assert result1 == expected1

    n2 = 2
    expected2 = {1640}
    result2 = lab.actors_with_bacon_number(db_tiny, n2)
    assert result2 == expected2

    n3 = 3
    expected3 = set()
    result3 = lab.actors_with_bacon_number(db_tiny, n3)
